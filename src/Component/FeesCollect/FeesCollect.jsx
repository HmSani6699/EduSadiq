...
const FeesCollect = ({ setFeesCollectOpen }) => {
  return (
    <div className="fixed inset-0 z-[70] flex justify-center  lg:py-[30px] p-[10px] bg-black bg-opacity-50">
      <div className="bg-white  rounded-lg shadow-lg relative lg:w-[800px] w-full feesCollect overflow-x-auto">
        ...
        {/*  */}
        <div className="lg:flex items-center justify-between bg-[#f2f5ffa9] mx-[20px] p-[20px] rounded-[5px] my-[20px]">
          <div className="flex items-center gap-[10px]">
          ...
          <button className="flex items-center mt-[15px] lg:mt-0 bg-red-100 text-[14px] text-red-500 font-semibold py-[2px] px-[6px] rounded-[5px]">
            <GoDotFill />
            <p>Unpaid</p>
          </button>
        </div>
