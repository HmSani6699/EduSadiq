...
const ExamGradeList = ({ setCurrentPage, handleScheduleUpdateType }) => {
  return (
    <div>
      {/* =====> Tab Part Start <===== */}
      <PageMenuDiraction
      ...
      <div className="w-full overflow-x-auto bg-white rounded-[10px]  shadow-lg border">
        <div className="lg:flex items-center justify-between bg-white px-[20px] pt-[20px]">
          <h2 className="text-lg font-semibold">Exam Grade List</h2>
          ...
          <table className="w-full mt-5 text-left border-collapse table-auto min-w-[600px] ">
            <thead>
              <tr className="bg-[#f4f7fe] font-semibold text-sm md:text-base">
                <td className="whitespace-nowrap  h-10 pl-[40px]  text-[#202C4B] text-[14px]">
                  ID
                </td>
            ...
            <tbody>
              {[1, 2, 3, 4, 5].map((id, index) => (
                ...
                >
                  <td className="whitespace-nowrap text-[#3D5EE1]  text-[14px] pl-[40px] h-10 px-[20px] py-[13px]">
                    1
                  </td>
                  ...
                  <td className="whitespace-nowrap text-[#515B73] text-[14px]  h-10 px-2 py-[0px]">
                    <button className="flex items-center gap-[4px] ml-[10px] bg-green-100 text-[14px] text-green-500 font-semibold py-[2px] px-[15px] rounded-[5px]">
                      <GoDotFill />
                      <p>Pass</p>
                    </button>
                  </td>
