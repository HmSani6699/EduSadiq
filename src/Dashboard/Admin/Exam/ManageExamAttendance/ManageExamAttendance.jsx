              ...
              {[1, 2, 3, 4, 5].map((id, index) => (
                ...
                >
                  ...
                  <td className="whitespace-nowrap text-[#515B73] text-[14px] text-center h-10 px-[20px] py-[13px]">
                    <h2 className="bg-green-400 h-[20px] w-[10px] ml-[30px] text-center rounded-full"></h2>
                  </td>
                  <td className="whitespace-nowrap text-[#515B73] text-[14px] text-center h-10 px-[20px] py-[13px]">
                    <h2 className="bg-green-400 h-[20px] w-[10px] ml-[30px] text-center rounded-full"></h2>
                  </td>
...
export default ManageExamAttendance;
