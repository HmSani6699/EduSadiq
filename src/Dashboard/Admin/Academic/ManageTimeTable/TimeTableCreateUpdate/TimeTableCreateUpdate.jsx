...
const TimeTableCreateUpdate = ({ setCurrentPage, type }) => {
  return (
    <div>
      {/* =====> Tab Part Start <===== */}
      <div className="flex items-center justify-between pt-[10px] pb-[20px]">
        <div>
          <h2 className="text-[20px] font-semibold text-[#202C4B]">
            {type === "create" ? "  Add Time Table" : "  Update Time Table"}
          </h2>
          <div className="flex items-center gap-[10px]">
            ...
            <p className="text-[#6a72876c]">/</p>
            <p className="text-[#6A7287] text-[14px]">Add Time Table</p>
          </div>
        </div>
      </div>
...
export default TimeTableCreateUpdate;
