...
const SectionCreateUpdate = ({ type, setCurrentPage }) => {
  return (
    <div>
      {/* =====> Tab Part Start <===== */}
      <div className="flex items-center justify-between pt-[10px] pb-[20px]">
        <div>
          <h2 className="text-[20px] font-semibold text-[#202C4B]">
            {type === "create" ? "  Add Section" : "  Update Section"}
          </h2>
          <div className="flex items-center gap-[10px]">
            ...
            <p className="text-[#6a72876c]">/</p>
            <p className="text-[#6A7287] text-[14px]">Add Section</p>
          </div>
        </div>
      </div>
      <div className="bg-white border shadow-sm rounded-[5px] mb-[30px]">
        <div className="bg-[#e9edf4] px-[20px] py-[16px] rounded-t-[5px] flex items-center gap-[10px]">
          ...
          <h2 className="text-[#202C4B] font-semibold text-[18px]">Section</h2>
        </div>

        {/*  */}
        <div className="p-[20px] ">
          <InputField title={"Section Name"} />
        </div>
